...
${tw`w-full flex items-center h-[47px] pl-4 pr-1 py-2`}
...
${tw`h-[39px] rounded-[10px] text-xs font-bold	leading-[18px] mx-auto w-[175px] mt-3 text-[#414146] flex items-center justify-center`}
